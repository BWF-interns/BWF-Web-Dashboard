/**
 * Sidebar navigation for the warden dashboard.
 * Highlights the active route and shows the logged-in warden's name and role.
 */
"use client";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { useAuth } from "../hooks/useAuth";
import { LayoutDashboard, Users, Activity, DollarSign, MessageSquare, AlertCircle, LogOut, Shield } from "lucide-react";

const navItems = [
  { href: "/warden/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/warden/students", label: "Students", icon: Users },
  { href: "/warden/activities", label: "Activities", icon: Activity },
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col min-h-screen">
      ...
      <div className="p-4 border-t border-gray-100">
        ...
        <button onClick={logout} className="flex items-center gap-2 w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors">
