/**
 * Shared UI components for the warden module.
 * StatusBadge — color-coded status pill for activities, complaints, posts.
 * Pagination — previous/next page controls, hidden when only 1 page.
 */
"use client";
