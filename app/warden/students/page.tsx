 ...
 * Supports debounced search and pagination.
 * Includes an inline form to add new students.
 */
"use client";
...
import { Student } from "@/modules/warden/types";
            ...
            <tbody className="divide-y divide-gray-50">
              {students.length === 0 ? (
                ...
                <tr key={s._id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <Link href={`/warden/students/${s._id}`} className="text-blue-600 hover:underline font-medium">
                      View Profile
                    </Link>
                  </td>
                </tr>
